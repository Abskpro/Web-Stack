...
class EditPost extends Component {
    ...
    onDeleteImage(image) {
        ...
        function deleteImage() {
            ...
            if (imageLength == 1) {
                ...
                console.log(image);
                that.setState({
                    imageCollection: that.state.imageCollection.filter(
                        function (value) {
                            return value != image;
                        }
                    ),
    ...
    async onSubmit(e) {
        ...
        if (this.props.location.state.area) {
            ...
            axios
                .put(
                    `/api/profile/updatePost/${this.props.location.state._id}`,
                    data
                )
                .then((res) => {
                    console.log(res);
...
export default connect(mapStateToProps, { routeAndDisplay })(
    withRouter(EditPost)
);
